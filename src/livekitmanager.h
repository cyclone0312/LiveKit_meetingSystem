...
public:
  ...
  void
  onTrackUnsubscribed(livekit::Room &room,
...
class LiveKitManager : public QObject {
  ...
  Q_PROPERTY(QString serverUrl READ serverUrl WRITE setServerUrl NOTIFY
                 serverUrlChanged)
  Q_PROPERTY(QString tokenServerUrl READ tokenServerUrl WRITE setTokenServerUrl
                 NOTIFY tokenServerUrlChanged)
...
private:
  ...
  QMap<QString, QPointer<QVideoSink>> m_pendingVideoSinks;
};
