...
int main(int argc, char *argv[])
{
    ...
    QObject::connect(
        meetingController.liveKitManager(), &LiveKitManager::chatMessageReceived,
        &chatModel,
        [&chatModel](const QString &senderId, const QString &senderName,
    ...
    QObject::connect(meetingController.liveKitManager(),
                     &LiveKitManager::disconnected, &aiAssistant, [&aiAssistant]()
                     {
    ...
    if (mc)
    {
        QObject::connect(mc, &MediaCapture::rawAudioCaptured, &aiAssistant,
